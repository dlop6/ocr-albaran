 ...
 * @param {number} threshold - Valor de gris para considerar "blanco" (default 245)
 * @param {number} percentWhite - Porcentaje para considerar "casi blanca" (default 97)
 * @returns {Promise<boolean>} true si la imagen es casi blanca
 */
async function isImageBlank(imagePath, threshold = 245, percentWhite = 97) {
